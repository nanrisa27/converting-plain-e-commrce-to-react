            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p>
                            <strong>Obaju Ltd.</strong><br />13/25 New Avenue<br />New Heaven<br />45Y 73J<br />England<br /><strong>Great br/itain</strong></p><Link to="contact.html">Go to contact page</Link>
