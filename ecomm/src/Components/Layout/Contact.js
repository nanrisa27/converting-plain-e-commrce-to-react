                                ...
                                <div className="card sidebar-menu mb-4">
                                    ...
                                    <div className="card-body">
                                        <ul className="nav nav-pills flex-column">
                                            <li><Link to="text.html" className="nav-link">Text page</Link></li>
                                            <li><Link to="contact.html" className="nav-link">Contact page</Link></li>
                                            <li><Link to="faq.html" className="nav-link">FAQ</Link></li>
                                        </ul>
                                    </div>
                                </div>

                                <div className="banner"><Link to="#"><img src="img/banner.jpg" alt="sales 2014" className="img-fluid" /></Link></div>
                            </div>
                                ...
                                <div id="contact" className="box">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <ul>
                                                <li><strong><Link to="mailto:">info@fakeemail.com</Link></strong></li>
                                                <li><strong><Link to="#">Ticketio</Link></strong> - our ticketing support platform</li>
                                            </ul>
                                        </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <p className="text-center text-lg-right">Template design by <Link to="https://bootstrapious.com/p/big-bootstrap-tutorial">Bootstrapious</Link></p>
